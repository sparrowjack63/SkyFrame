...
const CUSTOM_META={
  ...
  "NGC7000":{name:"NGC 7000 — Amérique du Nord",   filter:"lextreme",emission:true, desc:"Immense nébuleuse Ha dans le Cygne. Grand champ idéal.",notes:"Été. L-eXtreme.",                                                 rating:{stars:5,tag:"IDÉAL",   comp:"IC5070",   reason:"Amérique du Nord 2° — grand champ parfait avec le Pélican"}},
  "IC5070": {name:"IC 5070 — Pélican",             filter:"lextreme",emission:true, desc:"Nébuleuse du Pélican accolée à l'Amérique du Nord dans le Cygne.",notes:"Été. L-eXtreme. Compagnon naturel de NGC7000.",                rating:{stars:5,tag:"IDÉAL",   comp:"NGC7000",  reason:"Pélican 1° — compagnon direct de l'Amérique du Nord"}},
  "NGC7023":{name:"NGC 7023 — Iris",               filter:"rgb",     emission:false,desc:"Nébuleuse par réflexion bleutée dans Céphée, entourée de poussières sombres.",notes:"Été/automne. RGB prioritaire pour préserver la poussière.", rating:{stars:4,tag:"BON",    comp:null,       reason:"Iris 18' — réflexion et poussières, très adaptée au champ APS-C"}},
  "NGC6992":{name:"NGC 6992 — Voile du Cygne",     filter:"lextreme",emission:true, desc:"Rémanent supernova. Filaments Ha+OIII très fins.",     notes:"Été. L-eXtreme. Grand champ idéal.",                               rating:{stars:5,tag:"IDÉAL",   comp:"NGC6960",  reason:"Voile du Cygne E — filaments sur 1°, splendide"}},
  "NGC6960":{name:"NGC 6960 — Dentelles Ouest",    filter:"lextreme",emission:true, desc:"Partie ouest des Dentelles du Cygne, la Witch's Broom, dans le complexe du Voile.",notes:"Été. L-eXtreme. Complément évident de NGC6992.",                rating:{stars:5,tag:"IDÉAL",   comp:"NGC6992",  reason:"Dentelles Ouest — contrepartie iconique de NGC6992 dans le même complexe"}},
  "IC1318": {name:"IC 1318 — Région de Sadr",      filter:"lextreme",emission:true, desc:"Grande région HII autour de Sadr dans le Cygne, riche en Ha et en nébulosités sombres.",notes:"Été. L-eXtreme. Grand champ parfaitement adapté au RedCat.",rating:{stars:5,tag:"IDÉAL",   comp:null,       reason:"Sadr 3° — champ emblématique du Cygne en grand angle"}},
  "NGC6914":{name:"NGC 6914",                      filter:"rgb",     emission:false,desc:"Nébuleuse de réflexion bleutée dans le Cygne, bien mise en valeur avec son environnement poussiéreux.",notes:"Été. RGB prioritaire, duo-band possible en appoint.", rating:{stars:4,tag:"BON",    comp:null,       reason:"NGC6914 — réflexion et poussières, petite mais très photogénique"}},
  "IC4592": {name:"IC 4592 — Blue Horsehead",      filter:"rgb",     emission:false,desc:"Grande nébuleuse par réflexion autour de Nu Scorpii, connue pour sa silhouette de tête de cheval bleutée.",notes:"Été. Très basse au sud depuis la France, mais exploitable sur horizon propre. RGB prioritaire.",astrobinQuery:"IC 4592 Blue Horsehead", aliases:["Blue Horsehead","Blue Horsehead Nebula","Nu Scorpii Nebula","LBN 1113"], rating:{stars:3,tag:"MOYEN", comp:null, reason:"Réflexion 60' très basse sur l'horizon sud — belle cible si dégagée"}},
  ...
  "LDN1235":{name:"LDN 1235 — Dark Shark",         filter:"rgb",     emission:false,desc:"Grande nébuleuse sombre de Céphée, sculptée dans un complexe poussiéreux avec faibles zones en réflexion.",notes:"Automne. RGB prioritaire. Cible exigeante en ciel noir et en temps d'intégration.",astrobinQuery:"LDN 1235 Dark Shark",groupMembers:["vdB149","vdB150","LBN535"],rating:{stars:5,tag:"IDÉAL",   comp:null,       reason:"Dark Shark 2.5° — grand champ poussière iconique pour APS-C"}},
  "Barnard150":{name:"Barnard 150 — Seahorse",     filter:"rgb",     emission:false,desc:"Nébuleuse sombre filamenteuse de Céphée formant une silhouette d'hippocampe sur un fond riche de Voie Lactée.",notes:"Été/automne. RGB prioritaire. Petite en taille brute mais très lisible grâce à sa forme.",astrobinQuery:"Barnard 150 Seahorse",groupMembers:["LDN1082","GF9"],rating:{stars:4,tag:"BON",    comp:"Sh2-129,NGC6946",reason:"Seahorse — silhouette sombre rare dans un champ Céphée très rentable"}},
  "VdB141": {name:"vdB 141 — Ghost Nebula",        filter:"rgb",     emission:false,desc:"Nébuleuse de réflexion et poussières dans Céphée, fameuse pour sa silhouette de fantôme.",notes:"Été/automne. RGB prioritaire. Très belle cible poussière à proximité de l'Iris.",astrobinQuery:"vdB 141 Ghost Nebula",groupMembers:["Sh2-136","LDN1177"],rating:{stars:4,tag:"BON",    comp:"NGC7023",  reason:"Ghost Nebula 40' — réflexion et poussières, complément premium de l'Iris"}},
  "IC59_IC63":{name:"IC 59 + IC 63 — Ghost of Cassiopeia",filter:"rgb",emission:true,desc:"Duo naturel de nébulosités autour de Gamma Cassiopeiae, mêlant réflexion bleutée et émission Halpha.",notes:"Automne. HaRGB ou RGB avec appoint duo-band. Champ très éditorial mais étoile brillante à gérer.",astrobinQuery:"IC 59 IC 63 Gamma Cas",groupMembers:["IC59","IC63","Gamma Cas"],rating:{stars:4,tag:"BON",    comp:null,       reason:"IC 59/63 — duo réflexion+Ha très graphique autour de Gamma Cas"}},
  "B142_B143":{name:"Barnard 142 + 143 — E Nebula",filter:"rgb",     emission:false,desc:"Paire de nébuleuses sombres dans l'Aigle, célèbre pour sa forme en lettre E sur fond stellaire dense.",notes:"Été. RGB pur. Sujet simple, graphique et très lisible en grand champ.",astrobinQuery:"Barnard 142 143 E Nebula",groupMembers:["B142","B143"],rating:{stars:4,tag:"BON",    comp:null,       reason:"Barnard's E 30' — silhouette immédiatement lisible dans la Voie Lactée"}},
...
const RATINGS={
  ...
  NGC6992:{stars:5,tag:"IDÉAL",   comp:"NGC6960",  reason:"Voile du Cygne E — filaments sur 1°, splendide"},
  NGC6960:{stars:5,tag:"IDÉAL",   comp:"NGC6992",  reason:"Dentelles Ouest — contrepartie iconique de NGC6992 dans le même complexe"},
  IC5070: {stars:5,tag:"IDÉAL",   comp:"NGC7000",  reason:"Pélican 1° — compagnon direct de l'Amérique du Nord"},
  NGC7023:{stars:4,tag:"BON",     comp:null,       reason:"Iris 18' — réflexion et poussières, très adaptée au champ APS-C"},
  IC1318: {stars:5,tag:"IDÉAL",   comp:null,       reason:"Sadr 3° — champ emblématique du Cygne en grand angle"},
  NGC6914:{stars:4,tag:"BON",     comp:null,       reason:"NGC6914 — réflexion et poussières, petite mais très photogénique"},
